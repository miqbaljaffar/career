...
// SIMULATED DATABASE STORE IN-MEMORY FALLBACK
const db = {
  currentUser: {
    id: "user_sarah_tan",
    fullName: "Sarah Tan",
  ...
  messages: [
    ...
    },
    {
      ...
      senderId: "user_daniel_lim",
      recipientId: "user_sarah_tan",
      content: "Splendid. Let know if you are open to junior contract alignments at Grab. We always appreciate developers who value refined user interactions.",
